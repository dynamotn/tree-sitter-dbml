...
static const uint16_t ts_parse_table[LARGE_STATE_COUNT][SYMBOL_COUNT] = {
  ...
  [1] = {
    ...
    [sym_keyword_def] = STATE(57),
    [sym_reference] = STATE(24),
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [29] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_setting_repeat1, 2), SHIFT_REPEAT(78),
  [32] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_setting_repeat1, 2), SHIFT_REPEAT(93),
  ...
  [40] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_setting_repeat1, 2), SHIFT_REPEAT(12),
  ...
  [62] = {.entry = {.count = 1, .reusable = false}}, SHIFT(103),
  ...
  [74] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_note, 3),
  ...
  [91] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_block_repeat1, 2), SHIFT_REPEAT(55),
  ...
  [105] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_source, 1),
  [107] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2),
  [109] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(92),
  [112] = {.entry = {.count = 2, .reusable = false}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(92),
  [115] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_source_repeat1, 2), SHIFT_REPEAT(95),
  ...
  [128] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_index_block_repeat1, 2), SHIFT_REPEAT(84),
  [131] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_index_block_repeat1, 2), SHIFT_REPEAT(31),
  [134] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_index_block_repeat1, 2), SHIFT_REPEAT(45),
  ...
  [149] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_composite_index, 3),
  [151] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_block, 3),
  [153] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_index_block, 3),
  [155] = {.entry = {.count = 1, .reusable = true}}, SHIFT(48),
  [157] = {.entry = {.count = 1, .reusable = true}}, SHIFT(33),
  [159] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_composite_index, 2),
  [161] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_reference, 5),
  [163] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_reference, 5),
  [165] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_definition, 2),
  [167] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_index_definition, 2),
  [169] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_note, 3),
  [171] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 3),
  [173] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 3),
  [175] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 4),
  [177] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 4),
  [179] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2),
  [181] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_block, 2),
  [183] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_definition, 3),
  [185] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_definition, 3),
  [187] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item, 3),
  [189] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item, 3),
  [191] = {.entry = {.count = 1, .reusable = true}}, SHIFT(35),
  [193] = {.entry = {.count = 1, .reusable = true}}, SHIFT(36),
  [195] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_item, 4),
  [197] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_item, 4),
  [199] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index_block, 2),
  [201] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_index_block, 2),
  [203] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_composite_index_repeat1, 2), SHIFT_REPEAT(84),
  [206] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_composite_index_repeat1, 2), SHIFT_REPEAT(48),
  [209] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_composite_index_repeat1, 2),
  [211] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_setting, 3),
  [213] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_index, 2),
  ...
  [221] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_setting, 2),
  ...
  [239] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table, 1),
  [241] = {.entry = {.count = 1, .reusable = true}}, SHIFT(44),
  [243] = {.entry = {.count = 1, .reusable = false}}, SHIFT(5),
  [245] = {.entry = {.count = 1, .reusable = true}}, SHIFT(28),
  [247] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 3),
  [249] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type, 3),
  [251] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_table, 2),
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_type, 1),
  [255] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym_type, 1),
  ...
  [299] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_keyword_def, 1),
